...
This is ***Milestone 6***. Below is an overview of my project program *Prayer Request Tracker*. This submission can be divided into multiple sections. Please review the table of contents for this submission:
...
This application manages one main "product type", a Prayer Request, and both frontends expose the same four user-facing views.
...
In this video I will demonstrate the full functionality of the application, demonstrating both React and Angular frontends for my Prayer Request Tracker application.
...
Upon completing this project, I've gained a better understanding of how different frontend frameworks can sit on top of the same backend while still preserving the same user-facing behavior.

One of my biggest goals for this project was trying to keep each frontend implementation as minimally disruptive as possible by preserving the backend API that already exists.

In its' final state, the Prayer Request Tracker is now a fully functional full stack application with both a working Angular frontend and a working React frontend.
